...
const HitoSigningDetails = ({
  ...
  useEffect(() => {
    navigation.addListener('beforeRemove', (e) => {
      ...
      e.preventDefault();
      KeyringController.cancelHitoSignRequest().then(() => {
  ...
  const onCancel = useCallback(async () => {
    await KeyringController.cancelHitoSignRequest();
  ...
  const onScanSuccess = useCallback(
    (ur: UR) => {
      ...
      if (HitoState.sign.request?.requestId === requestId) {
        KeyringController.submitHitoSignature(
          HitoState.sign.request?.requestId as string,
    ...
    [
      KeyringController,
      HitoState.sign.request?.requestId,
      failureCallback,
      successCallback,
      trackEvent,
    ],
        ...
        <ScrollView contentContainerStyle={styles.wrapper}>
          ...
          >
            ...
            >
              ...
              <AnimatedHitoCode
                cbor={HitoState.sign.request.payload.cbor}
                type={HitoState.sign.request.payload.type}
                shouldPause={
...
export default HitoSigningDetails;
